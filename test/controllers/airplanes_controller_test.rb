...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { colomns: @airplane.colomns, name: @airplane.name, rows: @airplane.rows } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { colomns: @airplane.colomns, name: @airplane.name, rows: @airplane.rows } }
